...
WEAK void TIMER0_BRK_IRQHandler(void);             // 40:TIMER0 Break
WEAK void TIMER0_UP_IRQHandler(void);              // 41:TIMER0 Update
WEAK void TIMER0_TRG_CMT_IRQHandler(void);         // 42:TIMER0 Trigger and Commutation
...
WEAK void TIMER7_BRK_IRQHandler(void);             // 59:TIMER7 Break
WEAK void TIMER7_UP_IRQHandler(void);              // 60:TIMER7 Update
WEAK void TIMER7_TRG_CMT_IRQHandler(void);         // 61:TIMER7 Trigger and Commutation
...
void TIMER0_BRK_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void TIMER0_UP_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void TIMER0_TRG_CMT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
void TIMER7_BRK_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void TIMER7_UP_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void TIMER7_TRG_CMT_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
WEAK void TIMER0_BRK_IRQHandler(void) {
	TIMER0_BRK_DriverIRQHandler();
}

WEAK void TIMER0_UP_IRQHandler(void) {
	TIMER0_UP_DriverIRQHandler();
}

WEAK void TIMER0_TRG_CMT_IRQHandler(void) {
	TIMER0_TRG_CMT_DriverIRQHandler();
}
...
WEAK void TIMER7_BRK_IRQHandler(void) {
	TIMER7_BRK_DriverIRQHandler();
}

WEAK void TIMER7_UP_IRQHandler(void) {
	TIMER7_UP_DriverIRQHandler();
}

WEAK void TIMER7_TRG_CMT_IRQHandler(void) {
	TIMER7_TRG_CMT_DriverIRQHandler();
}
